...
fun SignUpScreen(navController: NavController, viewModel: AuthViewModel) {
    ...
    LaunchedEffect(key1 = authState.value){
        Log.d("TAG", "SignUpScreen: ${authState.value}")
        when{
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                ...
                title = { Text(text = "Sign Up Screen", style = MaterialTheme.typography.headlineLarge, fontWeight = FontWeight.Bold) })
        }
    ){ innerPadding ->
            ...
            Column(
                ...
                OutlinedTextField(value = username, onValueChange = {username = it},
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            textColor = if (textColor == Color.Black) color else Color.Black
                        },
                    singleLine = true
                )
                ...
                Button(
                    ...
                    onClick = {
                        viewModel.signUp(username, email, number, password)
                    },
                    enabled = username.isNotBlank() && email.isNotBlank() && number.isNotBlank() && password.isNotBlank()
                ){
                    Text(text = "Sign Up",
